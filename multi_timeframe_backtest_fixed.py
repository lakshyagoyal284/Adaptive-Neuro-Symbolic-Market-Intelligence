"""
Multi-Timeframe Backtesting System (Fixed)
...
class MultiTimeframeBacktester:
    ...
    def run_single_timeframe(self, timeframe: Dict[str, Any], initial_capital: float) -> Dict[str, Any]:
        ...
        try:
            ...
            # Run backtest with specific timeframe
            print(f"   🔄 Running {timeframe['days']} days simulation...")
            metrics = backtester.run_backtest(days=timeframe['days'], initial_capital=initial_capital)
