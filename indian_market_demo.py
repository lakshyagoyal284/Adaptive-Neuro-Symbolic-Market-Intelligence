"""
Indian Market Trading Demo
Demonstrates the trading system with real Indian stock data
"""
...
class IndianMarketDemo:
    """Indian market trading demonstration"""
    ...
    def __init__(self, initial_capital=10000):
        ...
        # Define Indian stock tickers (NSE)
        self.tickers = [
            'RELIANCE.NS', 'TCS.NS', 'HDFCBANK.NS', 'INFY.NS', 'ICICIBANK.NS',
            'HINDUNILVR.NS', 'SBIN.NS', 'BHARTIARTL.NS', 'KOTAKBANK.NS', 'LT.NS'
        ]
        
        print(f"Indian Market Trading Demo")
        print(f"Initial Capital: ${self.capital:,.2f}")
        print(f"Analyzing {len(self.tickers)} Indian stocks")
    ...
    def execute_trade(self, ticker, signal, current_price):
        ...
        # Calculate position size (2% of capital per trade for demo)
    ...
    def run_demo_cycle(self):
        """Run one complete trading cycle demo"""
        print(f"\n{'='*80}")
        print(f"INDIAN MARKET TRADING DEMO CYCLE")
        print(f"{'='*80}")
...
def main():
    """Main function to run Indian market demo"""
    try:
        print("INDIAN MARKET TRADING DEMONSTRATION")
        print("="*80)
        ...
        # Initialize trader
        trader = IndianMarketDemo(initial_capital=10000)
        
        # Run demo cycle
        trader.run_demo_cycle()
        
        # Display final results
        trader.display_final_results()
        
        print(f"\nDemo completed! During actual market hours (9:15 AM - 3:30 PM IST),")
        print(f"the system would run continuously with 5-minute intervals.")
