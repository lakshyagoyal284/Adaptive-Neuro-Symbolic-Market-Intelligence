...
class ContinuousMarketTrader:
    ...
    def __init__(self, initial_capital=10000):
        ...
        print(f"Continuous Market Trader Initialized")
    ...
    def get_market_data(self, ticker, period='1d'):
    ...
    def generate_trading_signal(self, price, sma_20, sma_50, rsi, volatility, price_change):
        ...
        if (price > sma_20 and sma_20 > sma_50 and 
            rsi < 70 and rsi > 30 and volatility < 4 and price_change > 0):
            signal = {
                'action': 'BUY',
                'confidence': 0.8,
        ...
        # Buy signals
              ...
              price_change > 1.0 and volatility < 5):
            signal = {
                'action': 'BUY',
                'confidence': 0.7,
        ...
        # Sell signals
        elif (price < sma_20 and rsi > 70 and volatility > 3):
            signal = {
                'action': 'SELL',
                'confidence': 0.7,
        ...
        # Strong sell signals
              ...
              price_change < -2.0 and volatility > 4):
            signal = {
                'action': 'SELL',
                'confidence': 0.8,
            ...
            try:
                ...
                if not self.is_market_open():
                    ...
                    if current_time >= self.market_close_time:
                        ...
                        print(f"\nMARKET CLOSED - Waiting for market open...")
...
def main():
    """Main function to run continuous trading"""
    try:
        print("CONTINUOUS MARKET TRADING SYSTEM")
        print("="*80)
        ...
        # Initialize trader
        trader = ContinuousMarketTrader(initial_capital=10000)
